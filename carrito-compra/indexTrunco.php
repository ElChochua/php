...
if (!isset($_SESSION['username'])) {
    ...
    //header("Location: /scripts/carrito-compras/login-register/db-manager.php");
...
<body>
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <div class="icon-group">
                <a id="bypass-over" href="/carrito-compra/logout.php">
                    <?php echo $_SESSION['username']; ?> <i class="fa fa-user-o" aria-hidden="true"></i>
                </a>
    ...
    <div class="main-container">
        ...
        <div class="container-productos">
            ...
            <div id="extra-margin" class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/pera.webp" alt="Product Image">
                <div class="card-content">
                    <div class="product-name">Pera</div>
                    <div class="product-price-tag">Precio</div>
                    <div class="product-price">$99.99</div>
                    <button class="add-to-cart">Agregar al carrito
                        <i class="fas fa-shopping-cart"></i>
            ...
            <div id="extra-margin" class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/platano.webp" alt="Product Image">
                <div class="card-content">
                    <div class="product-name">Plátano</div>
                    <div class="product-price-tag">Precio</div>
                    <div class="product-price">$99.99</div>
                    <button class="add-to-cart">Agregar al carrito
                        <i class="fas fa-shopping-cart"></i>
            ...
            <div class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/sandia.webp" alt="Product Image">
                <div class="card-content">
                    <div class="product-name">Sandia</div>
                    <div class="product-price-tag">Precio</div>
                    <div class="product-price">$99.99</div>
                    <button class="add-to-cart">Agregar al carrito
                        <i class="fas fa-shopping-cart"></i>
            ...
            <div class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/uvas.webp" alt="Product Image">
                <div class="card-content">
                    <div class="product-name">Uvas</div>
                    <div class="product-price-tag">Precio</div>
                    <div class="product-price">$99.99</div>
                    <button class="add-to-cart">Agregar al carrito
                        <i class="fas fa-shopping-cart"></i>
            ...
            <div class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/kiwi.jpeg" alt="Product Image">
                <div class="card-content">
            ...
            <div class="card">
                <img class="card-image" src="/assets/carrito-compra/frutas/coco.png" alt="Product Image">
                <div class="card-content">
